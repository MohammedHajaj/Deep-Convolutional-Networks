...
template<int>
__global__ void DataAugmentation(float *XCrop, unsigned char *Red, unsigned char *Green, unsigned char *Blue, unsigned int * Height, unsigned int *Width, size_t *Start, int *Indx, unsigned int *Crop, float *RGB, float *Cropf, int IR1)
{
	//-------------------------------------------------------------------------------------------------------------------------------------------------
	/*
...
__global__ void DataAugmentationInference(float *XCrop, unsigned char *Red, unsigned char *Green, unsigned char *Blue, unsigned int * Height, unsigned int *Width, size_t *Start, int *MTX, unsigned int *Flip, int epoch, int IR1)
{
	//-------------------------------------------------------------------------------------------------------------------------------------------------
	/*
...
template<int>
__global__ void DataAugmentationValidate(float *XCrop, unsigned char *Red, unsigned char *Green, unsigned char *Blue, unsigned int * Height, unsigned int *Width, size_t *Start, int *Indx, int IR1)
{
	//-------------------------------------------------------------------------------------------------------------------------------------------------
	/*
...
template<int>
__global__ void AdjustFixedMeansStds(float *SMU, int NumCh)
{
	//-------------------------------------------------------------------------------------------------------------------------------------------------
	/*
	...
	*/
	...
	float temp = float(TrainSizeM / BatchSize);
	if (ig < NumCh)
	{
...
template<int SIZE>
__global__ void RGBrandPCA(float *RGBrand, float *rand1)
{
	//-------------------------------------------------------------------------------------------------------------------------------------------------
	/*
