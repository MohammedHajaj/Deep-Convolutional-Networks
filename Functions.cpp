...
void AllocateAuxiliaryGPUMemory(float ***P_SMUs, float **P_YY, float **P_Y0, float **P_ws, float **P_rand1, float **P_randRGB, float **P_Cropf, unsigned int **P_Crop, float **P_mse, float **P_count, int **P_Indx1, int ***PIndx, int *PStart, int *Yr, int *Yc, int NParts, int In1)
{
	//----------------------------------------------------------------------------------------------------------------------------------------------
	/*
...
void InitializeConvLayerParam(int *IR, int *CR, int *SR, int *InCh, int *Xr, int *Xc, int *Yr, int *Yc, int *WSize, float **Buffer, int *P_In1)
{
	//----------------------------------------------------------------------------------------------------------------------------------------------
	/*
	...
	*/
	...
	int in1 = SR[CL - 1] * SR[CL - 1] * OutCh[CL - 1];
...
void InitializeCudaKernels(dim3 *gridSizeP, dim3 *gridSizeBN1, dim3 *gridSizeBN11, dim3 *gridSizeBN2, dim3 *gridSizeAddA, dim3 *P_gridSizeRGB, dim3 *P_gridSize_Crop, dim3 *P_gridSizePA, int *gridSizeAddYB, int *gridSizeAddWs, int *gridSizeAddW, int *P_gridSizeAddWF, int *SR, int *Yr, int *Yc, int *WSize, int *WsSize, int In1)
{
	//----------------------------------------------------------------------------------------------------------------------------------------------
	/*
