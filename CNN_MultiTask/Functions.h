...
void DividDatasetIntoMultipleTasks(int **, int **, int ****, int ***, int *, int *, int *, int *, int, int);

void DividTestsetIntoMultipleTasks(unsigned int **, int **, int ***, int **, int *, int *, int, curandGenerator_t);

void ReshuffleImagesMT(int *, int *, int ***, int **, int *, int);
...
void AllocateParamGPUMemory(float ***, float ***, float ***, float ***, float ***, float ***, float ***, float ***, float ***, float ***, float ***, float ***, float ***, float **, float **, float **, float **, float **, int ***, bool ***, int *, int *, int *, int *, int *, int *, int *, int);

void AllocateAuxiliaryGPUMemory(float ***, float **, float **, float **, float **, float **, float **, unsigned int **, float **, float **, int *, int *, int *, int, int);

void InitializeConvLayerParam(int *, int *, int *, int *, int *, int *, int *, int *, int *, float **);

void ParameterInitialization(float **, float **, float *, float **, float *, int *, int *, int);

void InitializeCudaKernels(dim3 *, dim3 *, dim3 *, dim3 *, dim3 *, dim3 *, dim3 *, dim3 *, int *, int *, int *, int *, int *, int *, int *, int *, int *, int);

void PrintIterResults(FILE *, float *, float *, int *, int, int, int, int, int);
