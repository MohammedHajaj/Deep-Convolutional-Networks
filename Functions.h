...
void AllocateAuxiliaryGPUMemory(float ***, float **, float **, float **, float **, float **, float **, unsigned int **, float **, float **, int **, int ***, int *, int *, int *, int, int);

void InitializeConvLayerParam(int *, int *, int *, int *, int *, int *, int *, int *, int *, float **, int *);
